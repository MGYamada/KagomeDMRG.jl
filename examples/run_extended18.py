#!/usr/bin/env python3
"""Validate the extended N18 Q0 model within one inclusive 600 s budget."""
...
def main():
    ...
    command = ["julia", "--project=research", "--startup-file=no", "--threads=1",
               "examples/validate_extended18.jl", str(output)]
    ...
    try:
        ...
        print(f"extended18 launcher: {error}", file=sys.stderr)
        return 2
