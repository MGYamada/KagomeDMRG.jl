#!/usr/bin/env python3
"""Add only NN N18 Q6 with an inclusive wall limit of at most 300 seconds."""
...
def main():
    ...
    command = ["julia", "--project=research", "--startup-file=no", "--threads=1",
               "examples/validate_static18_q6.jl", str(output)]
    ...
    try:
        ...
        print(f"static18 Q6 launcher: {error}", file=sys.stderr)
        return 2
